...
public class Application extends Controller {
    ...
    public static Result update(Long id) {
        ...
        flash("success", "Produk " + computerForm.get().name + " sudah di perbaharui");
        return GO_HOME;
    }
    ...
    public static Result save() {
        ...
        flash("success", "Produk " + computerForm.get().name + " telah dibuat");
        return GO_HOME;
    }
    ...
    public static Result delete(Long id) {
        ...
        flash("success", "Produk telah dihapus");
        return GO_HOME;
    }
